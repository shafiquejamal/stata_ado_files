program define pcre_varname_rescalar
	...
	syntax varname(string), REgularexpression(string asis) GENerate(name) [Optionmodifiers(string asis) perlprogramdirwithfinalslash]
	version 10.1
	...
	qui shell perl "`perlprogramdirwithfinalslash'stataregex_rescalar.pl" "`tfoutsheet.csv'" "`tfinsheet.csv'" "`generate'" `regularexpression' "`optionmodifiers'"
