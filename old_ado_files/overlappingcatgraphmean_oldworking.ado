program define overlappingcatgraphmean
	...
	// 	
	// Note that: 
	// 1. 'catvariablelabel' and 'catvariablelevel' must be entered exactly as is (without the quotes) - these are names of variables that the program creates
	...
	save `"`using'"', `replace'
	`gcmd' meanofvariable if meanofvariable ~= 0, `goptions'
	restore
